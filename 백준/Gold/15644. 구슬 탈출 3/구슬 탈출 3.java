...
public class Main {
    ...
    static void dfs(int depth, char[][] arr, int dir, String route) {
        // pruning
        ...
        for (int i=0; i<4; i++) {
            ...
            if (i == 0 && i != dir) {
                ...
                if (!balls[0].isAlive) {
                    ...
                    // 파란공이 안들어갔을 경우
                    if (balls[1].isAlive) dfs(depth+1, temp1, i, route + "U");
                }
            }
            ...
            // 하
                ...
                if (!balls[0].isAlive) {
                    ...
                    if (balls[1].isAlive) dfs(depth+1, temp2, i, route + "D");
                }
            ...
            // 좌
                ...
                if (!balls[0].isAlive) {
                    ...
                    if (balls[1].isAlive) dfs(depth+1, temp3, i, route + "L");
                }
            ...
            // 우
                ...
                if (!balls[0].isAlive) {
                    ...
                    if (balls[1].isAlive) dfs(depth+1, temp4, i, route + "R");
                }
